...
## 1/ GPT-6 Sol·Luna는 frontier intelligence의 가격을 절반으로 낮췄다
...
## 2/ FLUX 3 Action은 video foundation model을 7B robot policy로 가져왔다
...
## 3/ Robot의 GPU를 빼고 inference를 edge/cloud로 보내면 오히려 성공률이 올라갈 수 있다
