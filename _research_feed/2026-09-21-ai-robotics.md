...
## Anthropic은 Claude가 내부 AI R&D의 26%를 이미 ‘lead’한다고 측정했습니다.
...
## OpenAI는 automated AI research와 RSI를 ‘측정하고 보고해야 할 대상’으로 명시했습니다.
...
## NVIDIA는 Physical AI safety를 robot model 하나가 아니라 전체 stack의 문제로 정의했습니다.
